...
# AI Teaching Assistant - Restart Script
# This script stops current containers and restarts with latest changes

set -e

echo "🔄 Restarting AI Teaching Assistant..."
echo ""
...
# Option to rebuild or just restart
REBUILD=${1:-"rebuild"}

if [ "$REBUILD" = "fast" ]; then
...
echo ""
echo "🎉 AI Teaching Assistant restart complete!"
echo ""
echo "📋 Service URLs:"
...
echo ""
echo "⚡ Usage:"
echo "   ./restart.sh                        # Full rebuild (default)"
echo "   ./restart.sh fast                   # Fast restart (no rebuild)"
echo ""
echo "✅ Restart complete! Your changes are now active."